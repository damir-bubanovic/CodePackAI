...
def seed_rules() -> None:
    rules_by_profile = {
        "General": [
            ...
            ("exclude", "folder_name", ".idea", 1, 100, "IDE metadata"),
            ("exclude", "folder_name", ".vscode", 1, 100, "IDE metadata"),
            ...
            ("review", "extension", ".svg", 1, 100, "Vector image asset"),
        ...
        "Python": [
            ...
            ("include", "extension", ".md", 1, 100, "Markdown docs"),
            ("include", "extension", ".spec", 1, 100, "PyInstaller spec file"),
            ...
            ("include", "filename", ".gitignore", 1, 100, "Git ignore file"),
            ("exclude", "folder_name", ".git", 1, 100, "Git metadata"),
            ("exclude", "folder_name", "__pycache__", 1, 100, "Python cache"),
            ...
            ("exclude", "folder_name", "build", 1, 100, "Build output"),
            ("exclude", "folder_name", ".idea", 1, 100, "PyCharm project metadata"),
            ("exclude", "folder_name", ".vscode", 1, 100, "VS Code project metadata"),
